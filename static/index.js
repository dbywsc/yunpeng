...
function shareText(score) {
    ...
    SubmitResults();
    if (score <= 49) return '云鹏甚至没有翻过窗户';
    if (score <= 99) return '云鹏被后面地的狼狗抓住了';
    if (score <= 149) return '云鹏尝试拿起一箱红牛，但是他搬不动';
    if (score <= 199) return '云鹏忘了加油站有监控';
    return '云鹏成功的带着红牛回到了学校，但是第二天警察叔叔来了';
}
